                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <?php if(isset($_SESSION['usuario'])): ?>
                        ...
                        <?php if($_SESSION['usuario']['rol'] === 'admin'): ?>
                            <li class="nav-item">
                                <a class="nav-link text-warning" href="index.php?controller=adminController&action=index">
                    ...
                    <?php if(isset($_SESSION['usuario'])): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item text-danger" href="index.php?controller=loginController&action=logout"><i class="bi bi-box-arrow-right"></i> Cerrar sesión</a></li>
                            </ul>
                        </li>
