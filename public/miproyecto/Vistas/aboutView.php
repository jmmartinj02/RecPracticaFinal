    ...
    <div class="container py-5">
        ...
        <div class="cta-section bg-dark text-white rounded p-5 mt-5 text-center">
            ...
            <?php if(isset($_SESSION['invitado']) || !isset($_SESSION['usuario'])): ?>
                <a href="index.php?action=login" class="btn btn-primary btn-lg px-4 me-2">
                    <i class="bi bi-box-arrow-in-right"></i> Iniciar sesión
                </a>
                <a href="index.php?action=registro" class="btn btn-outline-light btn-lg px-4">
                    <i class="bi bi-person-plus"></i> Registrarse
                </a>
            <?php else: ?>
                <a href="index.php?action=eventos" class="btn btn-primary btn-lg px-4">
